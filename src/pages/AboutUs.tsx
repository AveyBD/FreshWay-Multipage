    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      ...
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap">
          ...
          <ServiceCard
            title="SDG ৭"
            details="গ্যাস, গোবর এবং ফসলের বর্জ্য থেকে শক্তি উৎপাদনেও সাশ্রয়ী এবং পরিচ্ছন্ন শক্তি সমর্থন করা হয়।"
          />
          <ServiceCard
            title="SDG ১২ "
            details="দায়িত্বশীল ভোগ ও উৎপাদন: দায়িত্বশীল ভোগ ও উৎপাদনকে উন্নীত করবে।            "
            />
          <ServiceCard
            title="SDG ১৩"
