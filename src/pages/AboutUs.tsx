...
const AboutUs = () => {
  return (
    ...
    <>
     <section className="overflow-hidden px-10 pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] bg-white dark:bg-dark">
        <div className="container mx-auto">
          <div className="flex flex-row-reverse flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-2/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                <h2 className="mb-5 text-3xl font-bold text-dark dark:text-white sm:text-[40px]/[48px]">
                আমাদের সম্পর্কে
                </h2>
                <p className="mb-5 pl-3 text-base text-body-color dark:text-dark-6">
                 এই উদ্যোগের মাধ্যমে, সম্ভাবনাময় এবং দায়িত্বশীল কৃষি প্রযুক্তি অনুসন্ধান করা হচ্ছে, যা বাংলাদেশের কৃষিতে একটি নতুন যুগ উদ্ভাসিত করতে সাহায্য করবে। এই পার্ক বাংলাদেশে প্রযুক্তিগত উন্নতি, পরিবেশবান্ধব, এবং সমাজবাদী মানবাধিকারের মানকে অভিবৃদ্ধি করতে একটি মাধ্যম হিসেবে প্রকাশ করবে।
                </p>
           ...
           {/* <p className="mb-8 text-base text-body-color dark:text-dark-6 pt-10 text-justify">
           বাংলাদেশে জীবিকা নির্বাহ, কর্মসংস্থান ও জিডিপি অবদানে কৃষি খাত মূল চালিকাশক্তি। যদিও কৃষি এখনও দেশের জিডিপিতে তৃতীয় সবচেয়ে বেশি অবদানকারী খাত, তবে গত দশকে এর অবদান কমেছে; ২০১০ সালের ১৭% থেকে ২০২০ সালে ১২.৬%। এই শিল্পটি রপ্তানি আয়েরও একটি গুরুত্বপূর্ণ উৎস এবং পোল্ট্রি ও গবাদি পশুরের খাদ্য, চামড়া, হিমায়িত খাবার, ডাবাবন্দ খাবার ইত্যাদির মতো অন্যান্য খাতের জন্য কাঁচামাল সরবরাহ করে। এটি বাংলাদেশী অর্থনীতির মেরুদণ্ড, অতীতে দারিদ্র্য হ্রাস ও খাদ্য নিরাপত্তা অর্জনে গুরুত্বপূর্ণ ভূমিকা পালন করেছে। ভবিষ্যতে টেকসই বৃদ্ধি নিশ্চিত করার জন্য, খাতটিকে উচ্চ-প্রযুক্তি কৃষি ও মূল্য শৃঙ্খল বিকাশে যেতে হবে, যাতে খরচ কমাতে, উৎপাদন বাড়াতে এবং উচ্চ মানের পণ্য অর্জন করা যায়। কাটার পরে প্রতি বছর ২.৩৮ বিলিয়ন ডলার (৩০,০০০ কোটি টাকা) কৃষি ফসলের ক্ষতি হয় (দ্য বিজনেস স্ট্যান্ডার্ড), এই ক্ষতি কৃষি প্রক্রিয়াজাতকরণ, প্যাকেজিং, সংরক্ষণ ও উন্নত লজিস্টিকের মাধ্যমে কমানো সম্ভব।
        </p>  */}
        </div>
      </section>
    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      ...
      <div className="container mx-auto">
        <div className="mx-4 flex flex-wrap">
          <div className="w-full px-4">
            ...
            <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-green-700 pb-8">ফ্রেশওয়ের প্রভাব বিবৃতি </h2>
              ...
              ফ্রেশওয়ের ইএসজি-অনুগত কৃষি প্রযুক্তি শিল্প পার্কটি বাংলাদেশে একটি উদ্ভাবনী এবং টেকসই প্রকল্প, যা জাতিসংঘের টেকসই উন্নয়ন লক্ষ্যমাত্রা (এসডিজি) এবং ইউরোপীয় ইউনিয়নের (ইইউ) বিধিবিধানের সাথে সামঞ্জস্যপূর্ণ।
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="-mx-4 flex flex-wrap">
          <ServiceCard
            title=" SDG ২"
            details="ক্ষুধা মুক্তি : এটি খাদ্য নিরাপত্তা বাড়ানো, দারিদ্র্য হ্রাস। যখন প্রত্যেক মানুষ, সব সময় পুষ্টিকর খাবার সহজে ও সাশ্রয়ী মূল্যে পেতে পারবে, তখনই খাদ্য নিরাপত্তা অর্জিত হবে।            "
          />
          <ServiceCard
            title="SDG ৬"
            details="পরিষ্কার পানি ও পয়ঃস্যানিটেশন : বৃষ্টির পানি সংগ্রহ এবং পানি শোধন প্লান্ট ব্যবহারের মাধ্যমে ফ্রেশওয়ে বাংলাদেশের পানি সল্প সমস্যা মোকাবেলায় সহায়তা করবে।"
          />
          <ServiceCard
            title="SDG ৭"
            details="সাশ্রয়ী মূল্যের এবং পরিচ্ছন্ন শক্তি : গ্যাস, গোবর এবং ফসলের বর্জ্য থেকে শক্তি উৎপাদনেও সাশ্রয়ী এবং পরিচ্ছন্ন শক্তি সমর্থন করা হয়।"
          />
          <ServiceCard
            title="SDG ১২ "
            details="দায়িত্বশীল ভোগ ও উৎপাদন: ফ্রেশওয়ের বৃষ্টির পানি সংগ্রহ করা এবং পানি শোধনাগারের ব্যবহারে দায়িত্বশীল ব্যবহার ও উৎপাদনের সাথে সারিবদ্ধভাবে দায়িত্বশীল ব্যবহার ও উৎপাদনকে উন্নীত করতে সাহায্য করবে।            "
            />
          <ServiceCard
            title="SDG ১৩"
            details="জলবায়ু ব্যবস্থা : সোলার প্যানেল থেকে সবুজ শক্তি ব্যবহারের মাধ্যমে এই প্রকল্পটি কার্বন নিঃসরণ কমিয়ে জলবায়ু পরিবর্তন মোকাবেলায় সহায়তা করবে।            "
             />
          <ServiceCard
            title="SDG ১৫"
            details="স্থলজীবন সমর্থন : টেকসই জমি ব্যবহারের পদ্ধতি উন্নীত করবে। আধুনিক কৃষি, টেকনোলজির সাথে, টেকসই জমি ব্যবহারে উন্নয়নের নতুন পথে।"
            />
        </div>
      </div>
    </section>
...
const ServiceCard = ({ icon, title, details }) => {
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3  py-8">
        <div className="border border-green-600 w-80 h-80  m-1 rounded-[20px] bg-white px-10 py-5 shadow-2 hover:shadow-lg dark:bg-dark-2 md:px-7 xl:px-10">
          <div className="mb-2 flex   w-[70px] items-center justify-center rounded-2xl bg-primary">
            {icon}
          </div>
