            ...
            <div className="col-span-4 lg:col-span-3">
              <div className="overflow-hidden bg-white rounded shadow-md text-slate-500 shadow-slate-200">
                <img
                  src={IMG2}
                  alt="card image"
                  className="aspect-video w-full  hover:border-amber-500 hover:transition-all hover:duration-1000 hover:border-8"
                />
                <div className="p-6">
                  <header>
                    <h3 className="text-lg font-medium text-center text-slate-700">
                      ১০০% জীবাণুমুক্ত
                    </h3>
                  </header>
                </div>
              ...
              <div className="overflow-hidden bg-white rounded shadow-md text-slate-500 shadow-slate-200">
                <figure>
                  <img
                    src={IMG3}
                    alt="card image"
                    className="aspect-video w-full hover:border-amber-500 hover:border-8"
                  />
                </figure>
